...
<?php 
   ...
   include "../controle/controle-listar-funcionarios-por-setor.php";
            ...
            <div id="formulario-cadastro">
                <form method="post" action="../controle/controle-editar-funcionario.php">
                    ...
                    <fieldset>
                        ...
                        <div><input type="hidden" name="idFunc" id="idFunc" value=<?= $_GET['idFunc'] ?>></div>
                        <div class="lado-esquerdo">
                            ...
                            <div>
                                <input class="campo-formulario" type="text" name="nome" id="nome" value="<?= $_GET['nome'] ?>" maxlength="25" 
                            ...
                            <div>
                                ...
                                <span id='spanTelefone' class="nao-visivel" >Ex: 99999-9999</span>
                            </div>
                            <div>
                                <input class="campo-formulario" type="text" name="telefone" id="telefone" value="<?= $_GET['telefone'] ?>" maxlength="25" 
                                autocomplete="off" autocorrect="off" autofocus placeholder="Informe um telefone" required
